...
/* root@localhost	RVU-PC-050	8.4.6	2025-09-29 11:28:34 */
...
-- Write the SQL Statement for the above Question
select e.department_id,d.department_name, max(salary), min(salary), avg(salary)
from Employees e , Departments d where e.department_id = d.department_id
group by department_id
...
-- Paste the output of above code and comment your output
/* 
department_id	department_name 	max(salary)	min(salary)	avg(salary)
90	            Executive	        24000.00	17000.00	19333.333333
100             Finance            	12000.00	6900.00	    8600.000000
30	            Purchasing	        11000.00	2500.00	    4150.000000
80	            Sales           	14000.00	6100.00	    8955.882353
20	            Marketing       	13000.00	6000.00	    9500.000000
70 	            Public Relations	10000.00	10000.00	10000.000000
110	            Accounting	        12000.00	8300.00  	10150.000000
*/
...
-- Write the SQL Statement for the above Questionc
